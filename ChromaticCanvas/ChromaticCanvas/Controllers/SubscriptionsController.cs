...
namespace ChromaticCanvas.Controllers
{
    public class SubscriptionsController : Controller
    {
        ...
        public SubscriptionsController(ChromaticCanvasDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Active,ExpirationDate")] Subscription subscription)
        {
